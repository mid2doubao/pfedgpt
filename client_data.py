...
df = pd.read_json("./dataset2/train/global_training2.json", orient='records')
...
data_path = os.path.join("re_dpa2", str(num_clients))
...
with open(os.path.join(data_path, "global_data.json"), 'w') as outfile:
...
if diff_quantity:
    ...
    while min_size < min_require_size:
        ...
        print(min_size)
        print([len(idx_j) for idx_j in idx_partition])
