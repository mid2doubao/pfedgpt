...
lora_config_path="./lora73.100-shepherd-7b/8/"
load_8bit="--load_8bit"
...
do
  ...
  lora_weights_path="./lora73.100-shepherd-7b/8/19/local_output_${client_number}/pytorch_model.bin"
  result_save_path="./private73.100/client${client_number}_1.json"
