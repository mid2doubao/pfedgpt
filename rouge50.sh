...
lora_config_path="./lora50-shepherd-7b-dpa1/50/"
load_8bit="--load_8bit"
...
do
  ...
  lora_weights_path="./lora50-shepherd-7b-dpa1/50/19/local_output_${client_number}/pytorch_model.bin"
  result_save_path="./private50_dpa1/client${client_number}_1.json"
  test_dataset_path="./lora50-shepherd-7b-dpa1/50/test_dataset_client_${client_number}.json"
