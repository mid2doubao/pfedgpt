...
lora_config_path="./lora72.100-shepherd-7b/8/"
load_8bit="--load_8bit"
...
do
  ...
  lora_weights_path="./lora72.100-shepherd-7b/8/19/local_output_${client_number}/pytorch_model.bin"
  result_save_path="./private72.100/client${client_number}_1.json"
  test_dataset_path="./FedDPA/data/dataset1/8/local_test_${client_number}.json"
