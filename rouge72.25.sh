...
lora_config_path="./lora72.25-shepherd-7b/8/"
load_8bit="--load_8bit"
...
do
  ...
  lora_weights_path="./lora72.25-shepherd-7b/8/19/local_output_${client_number}/pytorch_model.bin"
  result_save_path="./private72.25/client${client_number}_1.json"
