...
lora_config_path="./lora20-shepherd-7b-dpa1/20/"
load_8bit="--load_8bit"
...
do
  ...
  lora_weights_path="./lora20-shepherd-7b-dpa1/20/19/local_output_${client_number}/pytorch_model.bin"
  result_save_path="./private20_dpa1/client${client_number}_1.json"
  test_dataset_path="./lora20-shepherd-7b-dpa1/20/test_dataset_client_${client_number}.json"
